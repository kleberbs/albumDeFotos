<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%
    	UserX userx = (UserX)request.getAttribute("userx");
    %>
...
<body>
	...
	<div class="container">
		...
		<div class="form-group">
			<label>Email: </label>
			<input name="email" class="form-control" value="<%=user.getEmail()%>" readonly="readonly">
			</div> 
		<div class="form-group">
			<label>Usuario</label>
			<input name="user" class="form-control" value="<%=userx.getName() +" "+userx.getLastName()%>" readonly="readonly">
			</div>		
		<div class="form-group">
			<label>Lugar:</label>
			<input name="place" class="form-control" required="required" placeholder="Lugar">
			</div>
		<div class="form-group">
			<label>Fecha:</label>
			<input type="date" name="date" class="form-control" required="required" placeholder="Fecha"></div>
		<div class="form-group">
