...
public class Edit extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		User user = us.getCurrentUser();
		 if(user == null){		
			 ...
			 if(us.isUserAdmin() || accesResource(user.getEmail(),"/editRole")){
				 final PersistenceManager pm = PMF.get().getPersistenceManager();
					...
					try{
						...
						RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/Role/edit.jsp");
						rd.forward(req, resp);
					}catch(Exception e){
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		try{
			...
			req.setAttribute("role", role);
			RequestDispatcher rd = getServletContext().getRequestDispatcher("/WEB-INF/Role/view.jsp");
			rd.forward(req, resp);
		}catch(Exception e){
				System.out.println(e);
