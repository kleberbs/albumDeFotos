...
<body>
	...
	<div class="container">	
	<ul class="list-group">
	  <li class="list-group-item active">Usuario: <%=reservation.getUser()%></li>
	  <li class="list-group-item">Correo Electronico: <%=reservation.getEmail()%></li>
	  <li class="list-group-item">Lugar: <%= reservation.getPlace() %></li>
	  <li class="list-group-item">Fecha:<%=reservation.getDate() %></li>
	</ul>
	</div>
</body>
</html>